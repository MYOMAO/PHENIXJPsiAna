...
/*
	...
	TGraphErrors * ALICE = new TGraphErrors(NPointALICE,XALICE,YALICE,XALICEErr,StatErrorALICE);
	ALICE->SetLineColor(kMagenta-3);
	ALICE->SetMarkerColor(kMagenta-3);
	ALICE->SetMarkerSize(1);
	ALICE->SetMarkerStyle(22);

	TGraphErrors * ALICESyst = new TGraphErrors(NPointALICE,XALICE,YALICE,XALICESystError,SystErrorALICE);
	ALICESyst->SetFillColorAlpha(kMagenta-3,0.5);
	ALICESyst->SetLineColor(kMagenta-3);
*/
...
//		SystErrorALICE[i] = YALICE[i] - YALICESystLow[i];
	...
	ALICEPeri->SetLineColor(kGray);
	ALICEPeri->SetMarkerColor(kGray);
	...
	ALICEPeriSyst->SetFillColorAlpha(kGray,0.5);
	ALICEPeriSyst->SetLineColor(kGray);
